...
local full_display_sprite = {
	north = {
		filename = "__Filter_Combinator__/graphics/filter-combinator-display.png",
		width = 15,
		height = 11,
		scale = main.and_symbol_sprites.north.scale,
		shift = main.and_symbol_sprites.north.shift,
		hr_version = {
			filename = "__Filter_Combinator__/graphics/hr-filter-combinator-display.png",
			width = 30,
			height = 22,
...
local blank_sprite = {
	filename = "__Filter_Combinator__/graphics/blank.png",
	width = 1,
	height = 1,
	frame_count = 1,
	shift = {0, 0}
